...
var PRODUCT_SELECT = 'id, name, price, description, image_url, image_url_2, image_url_3, stock_quantity, stock_alert, stock_buffer, is_active, has_variants, category'
